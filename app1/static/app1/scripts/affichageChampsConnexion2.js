...
//$(function() {
    ...
    function afficherBoutonConnexion(){
        console.log("affichage btnaaaa connexion");
        //setTimeout(function() {
            var btnConnexion =
    ...
    $(window).load(function(){
        ...
        //Ecouteur de l'événement onChange sur le champ identifiant
            ...
            console.log("identifiant modifiiiiiiiiiiiié");
            //if ($)
